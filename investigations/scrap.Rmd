...
do_rbf_reg <- function(X, n) {
  ...
  list_rbf <- apply(centroids, 2, rbf)
  rbf_final <- function(x) invoke_map(list_rbf, x)
  transformed_X <-apply(X, 2, rbf_final)
  return(transformed_X)
}

rblm <- lm(data=df_filtered, magnit~I(rbf()))
```
