...
$$
In practice we would solve the corresponding system for $\vect{d}_k$
$$
...
samples <- rwmh_multivariate_log(start, niter=50000, log_posterior_unnormalized, vcov, thinning=1, burnin=0)
```
